...
/** ISO 3166-1 alpha-2 and ISD (international dialing) codes for signup. India is first (default). */
export const COUNTRY_DIAL_CODES: CountryDialCode[] = [
  ...
  { iso: "BN", name: "Brunei Darussalam", dial: "+673" },
  ...
  { iso: "LA", name: "Lao People's Democratic Republic", dial: "+856" },
