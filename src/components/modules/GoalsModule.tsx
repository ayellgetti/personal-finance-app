...
import { GoalType, Priority } from "@/types/finance";
...
const TYPES: GoalType[] = [
  "Dream Home", "Dream Car", "Child Education", "Child Marriage", "Retirement", "International Vacation", "Business Expansion", "Custom Goal",
];
...
export function GoalsModule() {
  ...
  const fields: FieldDef[] = [
    ...
    { name: "type", label: "Goal Type", type: "select", options: TYPES, span: 2 },
  ...
  return (
    <div className="space-y-6">
      ...
      ) : <Panel><EmptyState message="Add your first financial goal" /></Panel>}
    </div>
  );
}
