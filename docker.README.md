...
git pull && docker compose --env-file .env.prod -f docker-compose.prod.yml up -d --build api web

git pull && docker compose --env-file .env.prod -f docker-compose.prod.yml up -d --build web

docker compose --env-file .env.prod -f docker-compose.prod.yml up -d --build

docker compose --env-file .env.prod -f docker-compose.prod.yml build --no-cache web api
